...
needs to be persisted. Add a knowledge_repository-backed function here (not a new module)
when the first enrichment rule that actually needs curated reference data shows up.
"""
